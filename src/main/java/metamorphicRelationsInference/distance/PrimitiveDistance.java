...
import metamorphicRelationsInference.distance.util.ArrayUtils;
...
public class PrimitiveDistance {
  ...
  public static double distance(Field f1, Object obj1, Field f2, Object obj2) {
    ...
    Class<?> f1Type =
        f1.getType().getComponentType() == null ? f1.getType() : f1.getType().getComponentType();
    try {
  ...
  public static double distance(Object obj1, Object obj2) {
    ...
    Class<?> clazz =
        obj1.getClass().getComponentType() == null
            ? obj1.getClass()
      ...
      if (clazz.equals(int.class) || clazz.equals(Integer.class)) {
        if (obj1.getClass().isArray()) {
          if (clazz.equals(Integer.class)) {
            distance =
                intDistance(
                    ArrayUtils.toPrimitive((Integer[]) obj1),
                    ArrayUtils.toPrimitive((Integer[]) obj2));
          } else {
        ...
        if (obj1.getClass().isArray()) {
          if (clazz.equals(Character.class)) {
            distance =
                charDistance(
                    ArrayUtils.toPrimitive((Character[]) obj1),
                    ArrayUtils.toPrimitive((Character[]) obj2));
          } else {
        ...
        if (obj1.getClass().isArray()) {
          if (clazz.equals(Short.class)) {
            distance =
                shortDistance(
                    ArrayUtils.toPrimitive((Short[]) obj1), ArrayUtils.toPrimitive((Short[]) obj2));
          } else {
        ...
        if (obj1.getClass().isArray()) {
          if (clazz.equals(Long.class)) {
            distance =
                longDistance(
                    ArrayUtils.toPrimitive((Long[]) obj1), ArrayUtils.toPrimitive((Long[]) obj2));
          } else {
        ...
        if (obj1.getClass().isArray()) {
          if (clazz.equals(Float.class)) {
            distance =
                floatDistance(
                    ArrayUtils.toPrimitive((Float[]) obj1), ArrayUtils.toPrimitive((Float[]) obj2));
          } else {
        ...
        if (obj1.getClass().isArray()) {
          if (clazz.equals(Double.class)) {
            distance =
                doubleDistance(
                    ArrayUtils.toPrimitive((Double[]) obj1),
                    ArrayUtils.toPrimitive((Double[]) obj2));
          } else {
        ...
        if (obj1.getClass().isArray()) {
          if (clazz.equals(Boolean.class)) {
            distance =
                booleanDistance(
                    ArrayUtils.toPrimitive((Boolean[]) obj1),
                    ArrayUtils.toPrimitive((Boolean[]) obj2));
          } else {
        ...
        if (obj1.getClass().isArray()) {
          if (clazz.equals(Byte.class)) {
            distance =
                byteDistance(
                    ArrayUtils.toPrimitive((Byte[]) obj1), ArrayUtils.toPrimitive((Byte[]) obj2));
          } else {

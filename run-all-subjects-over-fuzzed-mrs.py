...
for filename in os.listdir(dir_path):
    if '.properties' in filename:
        ...
        result = subprocess.run(f'experiments/run-over-fuzzed-mrs.sh {subject_set} {subject_name} {gen_strategy} {mrs_to_fuzz} {allow_epa_loops}', shell=True, stdout=subprocess.PIPE)
